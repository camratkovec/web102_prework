...
function filterFundedOnly() {
    ...
    // ✅ log result for debugging / Secret Key
...
We need your help to fund these amazing game${numUnfunded === 1 ? "" : "s"}!`;


// create a new DOM element containing the template string and append it to the description container
const descElement = document.createElement("p");
descElement.innerText = displayStr;
descriptionContainer.appendChild(descElement);

console.log("Unfunded games:", numUnfunded);
...
console.log("Top funded:", firstGame.name);
